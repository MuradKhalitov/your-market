...
class LocationCatalogTest {
 ...
 @Test void metadataCatalogLoadsWithPriorityRegions(){assertEquals(java.util.List.of("DAGESTAN","CHECHNYA","INGUSHETIA"),catalog.regions().stream().limit(3).map(LocationCatalog.Region::code).toList());}
